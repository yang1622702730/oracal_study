/*
import com.fanyang.java.honorofking.*;
import com.fanyang.java.honorofking.Hreo.Hero;
import com.fanyang.java.honorofking.Menu.*;
import com.fanyang.java.honorofking.*;
import com.fanyang.java.honorofking.mingwen.Suming;
import com.fanyang.java.honorofking.mingwen.Tiaohe;
import com.fanyang.java.honorofking.mingwen.Xukong;
import com.fanyang.java.honorofking.skin.Yaseisskin;
import com.fanyang.java.honorofking.zhuangbei.Anyinzhanfu;
import com.fanyang.java.honorofking.zhuangbei.Fajia;
import com.fanyang.java.honorofking.zhuangbei.Shoe;
...
public class Deom {
    public static void main(String[] args) {
        ...
        Menu.Menulogin menulogin = new Menu.Menulogin();
        //穿戴皮肤
        ...
        if (menulogin.Menulogin() == 2) {
            ...
            int blue = 0;
            int green = 0;
            Menu.Menumingwen yaseismingwen = new Menu.Menumingwen();
        ...
        while (flag == 3) {
            Menu.Menuable menuable = new Menu.Menuable();
            Menu.Menuyeguai menuyeguai = new Menu.Menuyeguai();
            Menu.Menuzhuangbei menuzhuangbei = new Menu.Menuzhuangbei();
